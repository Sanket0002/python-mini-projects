...
class Quiz:
    ...
    def buttons(self):
        next_buttons=Button(gui,text="Next",command=self.next_btn,width=10,bg="blue",fg="white",font=("arial",16,"bold"))
    ...
    def display_title(self):
        title=Label(gui,text="current Affaris Quiz",width=50,bg="green",fg="white",font=("ariel",20,"bold"))
        title.place(x=0,y=2)
